      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <span className={`font-bebas text-xl ${!isYearly ? 'text-light' : 'text-muted'}`}>MONTHLY</span>
            <button 
            ...
            <span className={`font-bebas text-xl ${isYearly ? 'text-light' : 'text-muted'}`}>
        ...
        <div className="grid md:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
          {gymData.plans.map((plan, i) => (
            ...
            >
              ...
              <h3 className="font-bebas text-4xl text-light mb-2 tracking-wide">{plan.name}</h3>
              <div className="flex items-baseline gap-2 mb-8 border-b border-border pb-8">
                ...
                <span className="text-muted font-inter text-sm">/{isYearly ? 'yr' : 'mo'}</span>
              </div>
              ...
              <a 
                href={`https://wa.me/${gymData.whatsappNumber}?text=Hi,%20I%20want%20to%20subscribe%20to%20the%20${plan.name}%20plan.`}
                target="_blank"
